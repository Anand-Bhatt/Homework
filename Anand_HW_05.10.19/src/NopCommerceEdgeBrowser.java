...
public class NopCommerceEdgeBrowser {
    // This programme will open the given webpage using Edge browser
    public static void main(String[] args) {
        String baseUrl = "https://demo.nopcommerce.com/";

        System.setProperty("webdriver.EdgeDriver", "drivers/MicrosoftWebDriver.exe");
